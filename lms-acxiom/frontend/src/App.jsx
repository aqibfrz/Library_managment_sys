      ...
      <BrowserRouter>
        <UserContext.Provider value={{ userData, setUserData }}>
          <Routes>
            ...
            <Route path="/sign-up" element={<SignUp />} /> // if user is already signed in, this route shouldn;t open
            <Route path="/sign-in" element={<SignIn />} /> //  if user is already signed in, this route shouldn;t open
